        ...
        >
            ...
            >
                <Grid item align="center" xs={12}>
                    <ScrollAnimation animateIn="bounceIn" duration={1.5} >
                        <h2 >Qui sommes-nous</h2>
                    </ScrollAnimation>
                </Grid>
                <Grid item xs={12} md={6} align="left" className={styles.presentation_content}>
                ...
                <Grid item xs={8} md={4}>
                    <img src='/images/photoAPE.jpg' alt="groupeApe" className={styles.pres_img} />
                </Grid>
            </Grid>
            ...
            >
                <Grid item align="center" xs={12}>
                    <ScrollAnimation animateIn="bounceIn" duration={2.5} >
                ...
                <Grid item xs={12} sm={3} md={3}>
                    <ScrollAnimation animateIn="bounceIn">
                        ...
                        <img src='/images/transport.png' alt="groupeApe" className={styles.pres_ico} />
                    </ScrollAnimation>
                </Grid>
                <Grid item xs={12} sm={3} md={3}>
                    <ScrollAnimation animateIn="bounceIn" delay={200}>
                        <h4>les sorties culturelles</h4>
                        <img src='/images/musee.png' alt="groupeApe" className={styles.pres_ico} />
                    </ScrollAnimation>
                </Grid>
                <Grid item xs={12} sm={3} md={3}>
                    <ScrollAnimation animateIn="bounceIn" delay={300}>
                        <h4>les activités sportives</h4>
                        <img src='images/sport.png' alt="groupeApe" className={styles.pres_ico} />
                    </ScrollAnimation>
                ...
                <Grid item xs={12} sm={3} md={3}>
                    <ScrollAnimation animateIn="bounceIn" delay={400}>
                        ...
                        <img src='/images/classeverte.png' alt="groupeApe" className={styles.pres_ico} />
                    </ScrollAnimation>
                </Grid>
            </Grid>
        </Grid>
